...
use greenex\Excel\Concerns\FromView;
...
use greenex\Excel\Concerns\WithColumnFormatting;
use greenex\Excel\Concerns\WithCustomValueBinder;
use greenex\Excel\Concerns\WithCalculatedFormulas;
use greenex\Excel\Concerns\WithStrictNullComparison;
use greenex\Excel\Exceptions\SheetNotFoundException;
use greenex\Excel\Exceptions\ConcernConflictException;
...
class Sheet
{
    ...
    public function __construct(Worksheet $worksheet)
    {
        ...
        $this->chunkSize            = config('excel2.exports.chunk_size', 100);

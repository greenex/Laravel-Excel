...
use greenex\Excel\Tests\Data\Stubs\SheetWith100Rows;
use greenex\Excel\Tests\Data\Stubs\SheetForUsersFromView;
...
class WithMultipleSheetsTest extends TestCase
{
    ...
    {
        $this->expectException(\greenex\Excel\Exceptions\SheetNotFoundException::class);
